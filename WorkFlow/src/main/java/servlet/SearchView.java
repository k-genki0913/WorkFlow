...
public class SearchView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(documentTable.equals("RINGISHO")) {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("WEB-INF/jsp/serchRingisho.jsp");
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("WEB-INF/jsp/searchUserRegist.jsp");
			dispatcher.forward(request, response);
		}
	}
